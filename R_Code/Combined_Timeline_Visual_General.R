...
ggplot(data=dayplot,aes(x=as.Date(Days),y=as.numeric(as.character(Rank)),group=Show,color=Show)) +
...
ggsave(paste0(outputpath,"Long_Timeline_Total.pdf"),width=40,height=15,units="in")
